  ...
  <nav :class="theme">
    <div class="flex items-center justify-between p-4 md:px-16 lg:px-24 xl:px-32 md:py-4 w-full">
      ...
      <div class="hidden md:flex items-center gap-4">
        <!-- <nuxt-link to="/auth/signin" class="active:scale-95 hover:bg-indigo-50/50 transition px-4 py-2 border border-indigo-600 rounded-md text-slate-800 cursor-pointer">
          Sign in
        </nuxt-link> -->
